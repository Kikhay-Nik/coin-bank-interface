...
const createBackButton = function () {
  ...
  const buttonText = (0,redom__WEBPACK_IMPORTED_MODULE_5__.text)('Вернуться назад');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  account: 'По номеру',
  balance: 'По балансу',
  'transactions.date': 'По последней транзакции'
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((accountObj, router) => {
  ...
  const balance = (0,redom__WEBPACK_IMPORTED_MODULE_1__.el)('span.card-balance', `${accountObj.balance} ₽`);
  const inner = (0,redom__WEBPACK_IMPORTED_MODULE_1__.el)('div.card-inner.flex');
  const button = (0,redom__WEBPACK_IMPORTED_MODULE_1__.el)('button.btn-reset.fill-button.card-button', 'Открыть');
  ...
  if (accountObj.transactions.length) {
    ...
    const transactionTitle = (0,redom__WEBPACK_IMPORTED_MODULE_1__.el)('h4.card-transaction-title', 'Последняя транзакция:');
...
const createAccountsSection = (data, router) => {
  ...
  const accountTitle = (0,redom__WEBPACK_IMPORTED_MODULE_7__.el)('h1.main-title.account-title', 'Ваши счета');
  ...
  (0,redom__WEBPACK_IMPORTED_MODULE_8__.mount)(newAccountButton, (0,redom__WEBPACK_IMPORTED_MODULE_9__.text)('Создать новый счёт'));
...
const createDetailsSection = data => {
  ...
  const pageTitle = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('h1.main-title.details-title', 'Просмотр счёта ');
  ...
  const accountTilte = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('h2.details-account-title', `№ ${data.account}`);
  const accountBalanceWrapper = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('div.details-account-balance-wrrapper.flex');
  const accountBalanceTitle = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('h3.details-account-balance-title.second-title', 'Баланс');
  const accountBalanceValue = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('span.details-account-balance-value', `${data.balance} ₽`);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((maxValue, account) => {
  ...
  const formTitle = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('h2.transfer-title.second-title', 'Новый перевод');
  const transferFormInner = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('div.transfer-form-inner.flex');
  const {
    label: accountLabel,
    input: accountInput
  } = (0,_DOMUtils_createPageUtils__WEBPACK_IMPORTED_MODULE_0__.createLabelWithInput)('transfer', 'Номер счёта получателя', 'Введите счет', true);
  ...
  const {
    label: amountLabel,
    input: amountInput
  } = (0,_DOMUtils_createPageUtils__WEBPACK_IMPORTED_MODULE_0__.createLabelWithInput)('transfer', 'Сумма перевода', 'Введите сумму', true);
  ...
  const button = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('button.btn-reset.fill-button.transfer-button.flex', [buttonIcon, 'Отправить'], {
    type: 'submit'
  });
  ...
  transferForm.addEventListener('submit', async e => {
    ...
    if (transferInputs.length === successInputs.length) {
      ...
      console.log('🚀 ~ transferForm.addEventListener ~ transferResult:', transferResult);
...
function createLoginForm(submitHandler, router) {
  ...
  const button = (0,redom__WEBPACK_IMPORTED_MODULE_3__.el)('button.btn-reset.fill-button.auth-button', 'Войти', {
    type: 'submit'
  });
  (0,redom__WEBPACK_IMPORTED_MODULE_4__.mount)(buttonWrapper, button);
  (0,redom__WEBPACK_IMPORTED_MODULE_5__.setChildren)(loginLabel, [(0,redom__WEBPACK_IMPORTED_MODULE_6__.text)('Логин'), loginInput], (0,_DOMUtils_createPageUtils__WEBPACK_IMPORTED_MODULE_0__.createErrorDisplayEl)());
  (0,redom__WEBPACK_IMPORTED_MODULE_5__.setChildren)(passwordLabel, [(0,redom__WEBPACK_IMPORTED_MODULE_6__.text)('Пароль'), passwordInput, (0,_DOMUtils_createPageUtils__WEBPACK_IMPORTED_MODULE_0__.createErrorDisplayEl)()]);
...
const createAuthSection = router => {
  ...
  const authTitle = (0,redom__WEBPACK_IMPORTED_MODULE_4__.el)('h2.auth-title.main-title', 'Вход в аккаунт');
